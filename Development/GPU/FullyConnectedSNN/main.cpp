...
void processSignleInput(ClStructHolder& holder, vector<int>& sizes, vector<float>& input, vector<float>& output,
        vector<int>& counters, vector<int> spikes) {
...
void test() {
    ...
    inputs.push_back(125);
    inputs.push_back(125);
    vector<float > referrence;
    referrence.resize(10000, 0);
    vector<int> spikes;
    spikes.resize(40, -100);
    vector<int> spikesReferrence;
    spikesReferrence.resize(10000, 0);
    ...
    try {
        ...
        cl::Buffer layersBuffer(context, layerSizes.begin(), layerSizes.end(), true);
        ...
        cl::Buffer inputsBuffer(context, inputs.begin(), inputs.end(), true);
        cl::Buffer spikesBuffer(context, spikes.begin(), spikes.end(), true);
        cl::Buffer referrencesBuffer(context, referrence.begin(), referrence.end(), true);
        cl::Buffer spikesReferrenceBuffer(context, spikesReferrence.begin(), spikesReferrence.end(), true);
        kernel.setArg(0, layersBuffer);
        kernel.setArg(1, weightsBuffer);
        kernel.setArg(2, resultsBuffer);
        kernel.setArg(3, inputsBuffer);
        kernel.setArg(4, spikesBuffer);
        kernel.setArg(5, referrencesBuffer);
        kernel.setArg(6, spikesReferrenceBuffer);
